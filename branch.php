...
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Filière Ajouter avec succès</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Filière Modifier avec succès</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Filière supprimer avec succès</div>";
}
...
<head>
    ...
    <title>Système de paiement des frais de scolarité en ligne</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Filière
                    <?php
						echo (isset($_GET['action']) && @$_GET['action']=="Ajouter" || @$_GET['action']=="edit")?
						' <a href="branch.php" class="btn btn-primary btn-sm pull-right">Acceuil <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="branch.php?action=Ajouter" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Ajouter </a>';
						?>
                </h1>
...
?>
        ...
        <?php 
		 if(isset($_GET['action']) && @$_GET['action']=="Ajouter" || @$_GET['action']=="edit")
		 {
		?>
            ...
            <div class="col-sm-8 col-sm-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <?php echo ($action=="Ajouter")? "Ajouter": "Modifier"; ?>
                    </div>
                    <form action="branch.php" method="post" id="signupForm1" class="form-horizontal">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="Password"> Addresse </label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="detail"
                                        id="detail"><?php echo $detail;?></textarea>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            if ($("#signupForm1").length > 0) {
                $("#signupForm1").validate({
                    ...
                    messages: {
                        branch: "Veuillez saisir le nom de la succursale",
                        ...
                        <tbody>
                            <?php
									...
									echo '<tr>
											...
											<a onclick="return confirm(\'Êtes-vous sûr de vouloir supprimer cet enregistrement\');" href="branch.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a> </td>
                                        </tr>';
										$i++;
									}
									?>
