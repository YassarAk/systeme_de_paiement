...
<head>
    ...
    <title>Cours d'anglais arc-en-ciel </title>
            ...
            <div class="col-md-12">
                <fieldset class="scheduler-border">
                    ...
                    <form class="form-inline" role="form" id="searchform">
                        ...
                        <button type="button" class="btn btn-success btn-sm" id="find"> Trouve </button>
                        <button type="reset" class="btn btn-danger btn-sm" id="clear"> sup</button>
                    </form>
                </fieldset>
        ...
        $(document).ready(function() {
            ...
            */
            ...
            function mydatatable() {
                ...
                $("#subjectresult").html(
                    '<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Fees</th><th>Balance</th><th>Branch</th><th>DOJ</th><th>Action</th></tr></thead><tbody></tbody></table>'
                );
