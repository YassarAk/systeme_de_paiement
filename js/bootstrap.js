...
+(function ($) {
	...
	Carousel.prototype.to = function (pos) {
		...
		return this.slide(pos > activeIndex ? 'suivant' : 'précedent', $(this.$items[pos]));
	};

	Carousel.prototype.pause = function (e) {
		e || (this.paused = true);

		if (this.$element.find('.suivant, .précedent').length && $.support.transition) {
	...
	Carousel.prototype.slide = function (type, next) {
		...
		var fallback = type == 'suivant' ? 'Premier' : 'Dernier';
		var that = this;
