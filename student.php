            ...
            <div class="col-md-12">
                <h1 class="page-head-line">Etudiants
                    <?php
						...
						' <a href="student.php" class="btn btn-primary btn-sm pull-right">Acceuil <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="student.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Ajouter </a>';
						?>
                </h1>
                    ...
                    <form action="student.php" method="post" id="signupForm1" class="form-horizontal">
                        <div class="panel-body">
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border"> Information Personel:</legend>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="Old">D_Adh* </label>
                                    <div class="col-sm-10">
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="Old">Frais Total* </label>
                                    <div class="col-sm-10">
						...
						?>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="Old">Frais d'avance* </label>
                                    <div class="col-sm-10">
						...
						?>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="Old">Equilibre </label>
                                    <div class="col-sm-10">
						...
						?>
                            ...
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">information optionnelle:</legend>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="Old">Identifiant de l'e-mail </label>
                                    <div class="col-sm-10">
                        ...
                        <tbody>
                            <?php
									...
									echo '<tr '.(($r['balance']>0)?'class="danger"':'').'>
											...
											<a onclick="return confirm(\'êtes-vous sûr de vouloir supprimer cet enregistrement\');" href="student.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a> </td>
